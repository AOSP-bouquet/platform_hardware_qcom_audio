...
LOCAL_C_INCLUDES := \
    ...
    hardware/qcom/sdm660/audio/hal \
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    hardware/qcom/sdm660/audio/hal \
    hardware/qcom/sdm660/audio/hal/$(AUDIO_PLATFORM) \
    $(call include-path-for, audio-effects)
...
PRIMARY_HAL_PATH := hardware/qcom/sdm660/audio/hal
AUDIO_PLATFORM := $(TARGET_BOARD_PLATFORM)
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    hardware/qcom/sdm660/audio/hal \
    hardware/qcom/sdm660/audio/hal/audio_extn \
    hardware/qcom/sdm660/audio/hal/$(AUDIO_PLATFORM) \
